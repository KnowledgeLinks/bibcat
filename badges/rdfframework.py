...
class rdf_framework:
    ...
    def getProperty(self,**kwargs):
        ...
        return returnList      
    #def getFormLinkages(self,rdfForm):
    ...
    def saveForm(self,rdfForm):
        ...
        demo = self.__getFormData(rdfForm, classUri="https://w3id.org/openbadges#BadgeClass",subjectUri="http://localhost:8080/fedora/rest/29/74/ff/1d/2974ff1d-fc5e-4042-89f2-abfbb1dd26a0")
